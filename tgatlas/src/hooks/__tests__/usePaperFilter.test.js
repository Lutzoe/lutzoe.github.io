...
const mockPapers = [
  {
    title: 'Temporal Graph Connectivity',
    authors: 'Alice Smith, Bob Jones',
    labels: ['connectivity', 'temporal paths'],
    publications: [
      { name: 'STOC', year: 2023 },
  ...
  {
    title: 'Dynamic Network Flows',
    authors: ['Charlie Brown', 'Diana Prince'],
    labels: ['flows', 'dynamic networks'],
    publications: [{ name: 'SODA', year: 2022 }],
  },
  {
    title: 'Reachability in Temporal Graphs',
    authors: 'Eve Wilson',
    labels: ['reachability', 'temporal paths'],
    publications: [{ name: 'ESA', year: 2021 }],
  },
];
