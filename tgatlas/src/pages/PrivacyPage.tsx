    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Paper elevation={1} sx={{ p: 3, mb: 3 }}>
        ...
        <Typography paragraph>
          The Temporal Graph Atlas (TGA) website collects anonymous usage data
          to help us understand how researchers use our resource and which
          papers are most valuable to the community.
        </Typography>
