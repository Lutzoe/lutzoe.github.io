...
TGA (Temporal Graph Atlas) is a community-driven research resource built as a static site using
Vite + React 19. It maintains an overview of research on "Temporal Graphs" and helps researchers
navigate this field. Forked from the Algorithms with Predictions (ALPS) project.
